...
@section('content')
    ...
    <div class="container flex flex-col  gap-3">
        ...
        <div class="bg-[#f7f7f7] container md:pt-4 mx-auto  rounded-sm">
            <div class="font-bold text-[24px] mb-4">All courses uploaded</div>
            <div class="">
                <a href="/admin/uploadcourseget">
                    <button class="mb-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Upload new
                        course</button>
                </a>
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-end justify-between">
                                    ...
                                    <form action="{{ route('course.delete', $course->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Delete course</button>
