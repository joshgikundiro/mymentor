...
<div class=" my-4  justify-center sm:flex-col sm:my-0 sm:w-full md:flex md:flex-col lg:flex lg:flex-row  lg:w-[70%] lg:mx-auto"
            ...
            <form action="" method="POST" class=" sm:flex sm:flex-col md:p-5 bg-[#f9f9f9] lg:w-50 ">
                ...
                <div class="row">
                    ...
                    <div class="col ">
                        ...
                        <input type="text" class="form-control" placeholder="ex: joedeepdoe@gmail.com"
            ...
            <div
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#signupModal" ><button class=" btn btn-primary sm:text-[#5cb85c] sm:w-full font-bold md:text-[#fff] lg:w-52 lg:mx-14 "
