...
<div class=" my-4 md:px-5  sm:flex-col sm:my-0 sm:w-full md:flex md:flex-col lg:flex lg:flex-row  lg:w-[70%] lg:mx-auto"
    ...
    <form action="" method="POST" class=" sm:flex sm:flex-col bg-[#f7f7f7] px-5 md:p-5 gap-2">
        ...
        <input type="submit" class=" bg-[#5cb85c]  py-2 rounded-md text-white font-bold col-4 mt-3 w-72 lg:w-full "
...
<div
    class="lg:col flex flex-col lg:w-80 md:bg-[#5cb85c] lg:flex-col sm:flex-col sm:w-full sm:mx-auto  sm:justify-center lg:justify-center content-center">
    ...
    <div class="flex justify-center">
        ...
        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal class=" btn-outline-success">
            <button
                class=" w-40 rounded-md py-2  text-[#5cb85c]  font-bold lg:w-52 lg:mx-14 md:text-white md:border-2 md:border-[#fff] "
                style="background:none; border:1px solid #5cb85c;font-family:'archivo',sans-serif">Login</button></a>
                <x-login-modal>
                                        <x-slot:modeltitle>
                                            Login to myMentor as
                                        </x-slot:modeltitle>
                                        <x-slot:option1>
                                             A mentor
                                        </x-slot:option1>
