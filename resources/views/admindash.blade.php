...
<body class="">
    {{-- ⭐Beginning of side nav bar ⭐ --}}
    <aside class="">
        {{-- sidebar bar icons and logo for small devices ⭐ --}}
        <div class=" flex  w-full px-2 py-2 flex-row-reverse justify-between content-center">

            <button class="lg:hidden" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample"
        ...
        <div class="offcanvas  w-64 inset-y-0 px-2 py-3 bg-[#5cb85c] show" tabindex="-1" id="offcanvasExample"
            aria-labelledby="offcanvasExampleLabel" data-bs-scroll="true" data-bs-backdrop="false">
            <div class="offcanvas-header">
                <div class="" href="#offcanvasExample">

                </div>
                {{--  ⭐ sidebar ⭐ --}}
                <div
                    class="bg-[#5cb85c] fixed h-screen left-0 offcanvas-body top-0 transition-transform translate-x-0 w-64 z-40 overflow-y-hidden ">

                    <nav class="flex flex-col">
                        <a href="/admin" class="flex  px-3"><x-weblgo-ff></x-weblgo-ff></a>
                        <ul class="flex text-white flex-col font-semibold">
                            <li
                                class=" flex mb-2 p-3 justify-start  space-x-4 w-100 hover:bg-[#5cb85c] hover:border-b-2">
                            ...
                            <li
                                ...
                                <a href="/adviewcourses"> Course Repository </a>
                            </li>
                            {{-- <li
                                class=" flex mb-2 p-3 justify-start space-x-4 w-100 hover:bg-[#5cb85c] hover:border-b-2 ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <ul class="text-white font-bold">
                        ...
                        <li class=" flex mt-32 p-3 justify-start space-x-4 w-100 hover:bg-[#5cb85c] hover:border-b-2 ">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5">
                                <path fill-rule="evenodd"
